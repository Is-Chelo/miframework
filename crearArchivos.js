...
module.exports = class Crear {
    ...
    constructor(nombreFolder, endPoint, camposListado, camposRequeridos) {
    ...
    crearEdit() {
        ...
        resultUpdate = resultUpdate.replace(/{menu}/g, `menu.${this.nombreFolder.toLowerCase()}`);
        resultUpdate = resultUpdate.replace(/{form}/g, `form.edit${this.nombreFolder.toLowerCase()}`);
